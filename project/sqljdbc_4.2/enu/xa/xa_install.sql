...
-- distributed transaction and XA support for the Microsoft JDBC Driver 4.2 for SQL Server.
...
-- in Microsoft JDBC Driver 4.2 for SQL Server distributed transactions.
